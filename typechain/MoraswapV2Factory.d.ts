...
interface MoraswapV2FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class MoraswapV2Factory extends Contract {
  ...
  interface: MoraswapV2FactoryInterface;
